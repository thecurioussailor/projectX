...
const Card: React.FC<CardProps> = ({ gradient }) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center">
        <p className="text-xl font-semibold mt-2  tracking-wider">ads</p>
        <p className="text-white text-sm font-semibold tracking-wider">ads</p>
      </div>
    </div>
  );
};
