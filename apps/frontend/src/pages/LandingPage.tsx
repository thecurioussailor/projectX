           ...
           <div className="pt-8">
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               ...
               <div className="space-y-4">
                 <img src={logo} alt="TinyWallet" className="w-40" />
                 <p className="text-gray-400 text-sm">
                   Your complete digital business suite for managing products, links, and Telegram channels.
                 </p>
               </div>
               ...
               <div>
                 ...
                 <div className="space-y-2">
                   <Link to="/contact-us" className="block text-gray-400 hover:text-gray-300 text-sm">Contact Us</Link>
                   <a href="mailto:tinywallet.in@gmail.com" className="block text-gray-400 hover:text-gray-300 text-sm">Email Support</a>
                 </div>
               </div>
               ...
               <div>
                 ...
                 <div className="space-y-2">
                   <Link to="/privacy-policy" className="block text-gray-400 hover:text-gray-300 text-sm">Privacy Policy</Link>
                   <Link to="/terms-and-conditions" className="block text-gray-400 hover:text-gray-300 text-sm">Terms & Conditions</Link>
                   <Link to="/refund-policy" className="block text-gray-400 hover:text-gray-300 text-sm">Refund Policy</Link>
                   <Link to="/contact-us" className="block text-gray-400 hover:text-gray-300 text-sm">Disclaimer</Link>
                 </div>
               </div>
             </div>
            ...
            <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
              ...
              <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                &copy; 2025 TINYWALLET. All rights reserved.
              </p>
            </div>
          </div>
        </div>
