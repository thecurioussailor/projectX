        ...
        <div className="flex justify-between gap-4 bg-white rounded-[3rem] w-full overflow-clip shadow-lg shadow-purple-100">
            <div className="flex flex-col gap-4 w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-8 px-8 border-t justify-items-center border-gray-200">
                    ...
                    <MoneyCard amount={wallet?.totalCharges || 0} gradient="bg-gradient-to-r from-blue-400 to-blue-500" title="Charges Deducted" />
                    <MoneyCard amount={wallet?.pendingBalance || 0} gradient="bg-gradient-to-r from-indigo-500 to-indigo-700" title="Locked Balance" />
                    ...
                    <MoneyCard amount={wallet?.totalWithdrawn || 0} gradient="bg-gradient-to-r from-rose-400 to-red-500" title="Total Withdrawn" />
                </div>   
            </div>
        </div>
