      ...
      >
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-[#7e37d8]">{isSub ? "Telegram Subscription" : "Digital Product"}</h1>
            <button 
              onClick={handleClose}
          ...
          <div className="space-y-4">
            <div className="border-b pb-3">
              <p className="text-sm text-[#718096]">Purchased Item ID</p>
              <p className="font-medium">{purchasedItem.id}</p>
            </div>
            <div className="border-b pb-3 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <p className="font-medium text-sm">{purchasedItem.status}</p>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
                <button 
                    onClick={() => handle()}
                    className="p-2 px-4 rounded-full bg-[#7e37d8] text-white">{isSub ? "Invite Link" : "Product Link"}</button>
            </div>
          </div>
        </div>
      </div>
...
export default PurchasedItemSidePop;